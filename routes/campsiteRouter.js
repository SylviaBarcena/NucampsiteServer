...
const verifyAuthor = (req, res, next) => {
  ...
  .then((campsite) => {
      if (campsite != null && campsite.comments.id(req.params.commentId) != null) {
...
campsiteRouter
  ...
  .put(cors.corsWithOptions, authenticate.verifyUser, verifyAuthor, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite && campsite.comments.id(req.params.commentId)) {
          if (req.body.rating) {
  ...
  .delete(cors.corsWithOptions, authenticate.verifyUser, verifyAuthor, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite && campsite.comments.id(req.params.commentId)) {
